...
<asp:Content ID="Content1" ContentPlaceHolderID="c1" runat="server">
    ...
    <tr>
        ...
        <td><asp:TextBox runat="server" ID="email" TextMode="Email" Placeholder="Enter E-Mail" Font-Size="Larger"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="email" ErrorMessage="Email Can't Be Blank" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
    ...
    <tr>
        ...
        <td><asp:TextBox runat="server" ID="password" TextMode="Password" Placeholder="Enter Password" Font-Size="Larger"></asp:TextBox>
            <input type="checkbox" id="pass" onchange="shwpass(this)" />  Show Password
    ...
    <tr>
        ...
        <td><asp:TextBox runat="server" ID="address" Height="124px" Width="162px" Placeholder="Enter Address" TextMode="MultiLine" Font-Size="Larger"></asp:TextBox>
    ...
    <tr>
        ...
        <td><asp:TextBox runat="server" ID="mobile" TextMode="Phone" Font-Size="Larger" Placeholder="Enter a Mobile Number"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="mobile" ErrorMessage="Email Can't Be Blank" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
    ...
    <tr>
        <td colspan="2" align="center">
            <asp:Button ID="b1" OnClick="b1_Click" runat="server" Text="Register" CssClass="search-submit" style="width: 166px;
    margin-left: -213px;" />
            </td>
    </tr>
    <tr>
